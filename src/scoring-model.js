...
export const MOATS = [
  {
    ...
    hint: '0 = nobody is on the hook, 4 = someone can be sued or struck off',
  },
  {
    key: 'trust',
    ...
    hint: '0 = any provider is interchangeable, 4 = they hire you, not the service',
  },
  {
    key: 'embodied',
    label: 'Embodiment',
    ...
    hint: '0 = remote-only forever, 4 = atoms must move',
  },
  {
    key: 'taste',
    ...
    hint: '0 = one right answer, 4 = experts disagree, taste decides',
  },
  {
    key: 'access',
    ...
    hint: '0 = anyone with a laptop can do it, 4 = gated by who you are',
  },
];
